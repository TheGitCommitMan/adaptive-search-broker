...
class TestCoreEndpointDelegateIteratorEndpointContext(unittest.TestCase):
    """Initializes the TestCoreEndpointDelegateIteratorEndpointContext with the specified configuration parameters."""
